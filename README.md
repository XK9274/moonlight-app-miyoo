...
4. Create a local account and log in.
5. Copy the Moonlight app folder to `/mnt/SDCARD/App/moonlight`
6. Relaunch MainUI on your Miyoo or reboot.
7. Launch the Moonlight app and type in your PC's IP address.
